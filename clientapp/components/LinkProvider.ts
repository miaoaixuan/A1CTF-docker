/*
    Source from https://github.com/LabhanshAgrawal/xterm-link-provider
    The original version had some issues with package import, so I built this in.
*/

import type { IBufferCellPosition, ILink, ILinkProvider, Terminal } from '@xterm/xterm'; // edited this
